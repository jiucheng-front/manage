<template>
    <div id="content" class="app-content" role="main">
        <div class="app-content-body">
            ...
            <div class="wrapper-md" ng-controller="FormDemoCtrl">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-inline " id="on-html-form" role="form" action="http://192.168.25.23:8080/index.php" method="post">
                            ...
                            <div class="form-group">
                                <el-date-picker name="start-time" v-model="startDate" type="datetime"
                                                placeholder="开始日期时间"></el-date-picker>
                            </div>
                            <div class="form-group">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="table-responsive">
                        <el-table :data="tableData" @row-dblclick="handleEdit" stripe style="width: 100%">
                            <el-table-column prop="date" label="日期" style="width: 30%"></el-table-column>
                            <el-table-column prop="name" label="姓名" style="width: 30%"></el-table-column>
                            <el-table-column prop="address" label="地址" style="width: 30%"></el-table-column>
                        </el-table>
                    </div>
                    <!--分页开始-->
                    <div class="block">
                ...
                <div id="app-alert-button">
                    <el-dialog title="操作" v-model="dialogVisible" size="tiny">
            ...
            <!--查看内容开始-->
            <el-dialog title="添加" v-model="dialogVisible1Add" size="tiny">
    ...
    export default {
        ...
        mounted () {
            ...
            this.$nextTick(function () {
                ...
                var getDataUrl = "http://192.168.25.23:8080/index.php";
            ...
            $(document).ready(function () {
                ...
                $(document).on('click', '.ypp-btn-add', function () {
                    ...
                    .on('click', '.ypp-btn-update', function () {
                        ...
                        requestDelUrl = 'http://192.168.25.23:8080/index.php';
